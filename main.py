    ...
    try:
        ...
        while response.candidates and response.parts and response.parts[0].function_call:
            ...
            if tool_func:
                ...
                executed_tools.append(tool_result) # 결과 저장
            else:
